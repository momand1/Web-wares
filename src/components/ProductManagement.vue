    ...
    <div class="container">
      ...
      <form @submit.prevent="submitProduct">
        <div class="form-group">
          ...
          <input type="text" id="nom" v-model="newProduct.nom" class="form-control" required />
        </div>
        <div class="form-group">
    ...
    methods: {
      ...
      submitProduct() {
        if (this.editMode) {
          ...
          this.newProduct.id = Date.now(); // Génère un nouvel ID pour le produit
      ...
      resetForm() {
        this.newProduct = { nom: '', prix: '', categorieId: '', moq: '' };
        this.editMode = false;
      }
    },
    mounted() {
